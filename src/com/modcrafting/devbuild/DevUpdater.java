    ...
    class Handler extends DefaultHandler
    {
                ...
                final int length) throws SAXException
        {
            if (currentElement.equals("title"))
            {
                ...
                if (StringUtils.containsIgnoreCase(s, "DiabloDrops")&&StringUtils.containsIgnoreCase(s, "bleed"))
                {
                    versionTitle = s;
                }
            }
                ...
                throws SAXException
        {
            ...
            if (currentElement.equals("link"))
            {
                ...
                if (StringUtils.containsIgnoreCase(link, "DiabloDrops")&&StringUtils.containsIgnoreCase(link, "bleed"))
                {
                    versionLink = link;
                }
            }
